...
public class DinosaurViewController { // DinosaurViewController 클래스 선언

    // 인스턴스 변수 선언
    private DinosaurManager dinosaurManager; // DinosaurManager 객체를 저장하는 변수

    // DinosaurViewController 클래스의 생성자
    public DinosaurViewController(DinosaurManager dinosaurManager) { // DinosaurManager 객체를 매개변수로 받는 생성자
